                ...
                TriclopsInput const & triclopsInput )
{
    ...
    // Make 3d thing
    triclopsCreateImage3d(triclops,&depthImage);
    triclopsExtractImage3d(triclops,depthImage);
    ...
    const char * pDepthFilename = "depth.pgm";
    te = triclopsSaveImage( depthImage, const_cast<char *>(pDepthFilename) );
    _HANDLE_TRICLOPS_ERROR( "triclopsSaveImage()", te );
