                  ...
                  TriclopsInput   const & colorData )
{
    ...
    // <x> <y> <z> <red> <grn> <blu> <row> <col>
    // ...
     TriclopsError notok =  triclopsGetTriclopsToWorldTransform(triclops, &transform);
     _HANDLE_TRICLOPS_ERROR( "Get", notok );

    notok=  triclopsSetTriclopsToWorldTransform(triclops, transform);
 _HANDLE_TRICLOPS_ERROR( "Set", notok );
